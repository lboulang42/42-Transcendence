      ...
      resources: {
        ...
        fr: {
          translation: {
            ...
            error_alias_long:
              "L'alias doit comporter entre 1 et 15 caracteres.",
            ...
            pass_same:
              "L'ancien et le nouveau mot de passe ne peuvent pas etre pareil",
            pass_updated: "Mot de passe mis a jour",
            pass_old_incorrect: "Ancien mot de passe incorrect",
            cant_42:
              "Erreur : le nom d'utilisateur ne peut pas se terminer par '@42'",
            username_exist:
        ...
        it: {
          translation: {
            ...
            pass_same:
              "Le vecchie e le nuove password non possono essere le stesse",
