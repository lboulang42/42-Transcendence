...
export async function postScore(endpoint, score_user1, score_user2, user1, user2, quickplay) { // keeps track of scores
	const csrftoken = getCookie('csrftoken'); // cross site request forgery token to avoid cross site attacks
	...
	try {
		const response = await fetch(endpoint, {
			method: 'POST', // commonly used to created or update ressources on the server 
			headers: {
