...
function onWindowResize() {
	if (window.location.href.includes('quick_play') || window.location.href.includes('two_players') || window.location.href.includes('tournament') || window.location.href.includes('launch_game')) {
		var ren_width = window.innerWidth;
		var ren_height = window.innerHeight;
		if (ren_width < 700)
			ren_width = 700;
